...
class CIFARNormalizer(nn.Module):
...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, norm=False):
        ...
        self.norm = norm
        self.normalizer = CIFARNormalizer()
...
class CD_VAE(nn.Module):
    def __init__(self, vae_path, model_path):
        super(CD_VAE, self).__init__()
        self.vae = CVAE_cifar(d=32, z=2048, with_classifier=False)
